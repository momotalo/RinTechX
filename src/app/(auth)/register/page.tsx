      ...
      <div className="w-full max-w-6xl mx-auto">
        <div className="overflow-hidden bg-white shadow-2xl rounded-3xl">
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="relative flex items-center justify-center p-8 overflow-hidden animate-slide-in-left bg-gradient-to-br from-gray-900 to-gray-800 lg:w-1/2">
              {/* Background Pattern */}
